 ...
 */
var CollaborativeSelectionManager = /*#__PURE__*/function () {
  /**
  ...
  function CollaborativeSelectionManager(options) {
    ...
    _defineProperty(this, "_checkResize", function () {
      if (_this._textElement.offsetWidth !== _this._overlayContainer.offsetWidth || _this._textElement.offsetHeight !== _this._overlayContainer.offsetHeight || _this._textElement.offsetTop !== _this._overlayContainer.offsetTop || _this._textElement.offsetLeft !== _this._overlayContainer.offsetLeft) {
        _this.onResize();
