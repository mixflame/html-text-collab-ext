...
var TextInputManager = /*#__PURE__*/function () {
  /**
   *
   * @param options
   */
  ...
  _createClass(TextInputManager, [{
    ...
    value: function setTextOnInsertWithSelections(text, index, value) {
      ...
      var _this$_getSelection3 = this._getSelection(),
          start = _this$_getSelection3.start,
          end = _this$_getSelection3.end;
    ...
    value: function setTextOnDeleteWithSelections(text, index, length) {
      ...
      var _this$_getSelection4 = this._getSelection(),
          start = _this$_getSelection4.start,
          end = _this$_getSelection4.end;
